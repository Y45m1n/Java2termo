...
public class App {
    public static void main(String[] args) {
        ...
        AgendaConsulta agendaConsulta[] = new AgendaConsulta[10];
                ...
                if (acaoCadastro == 1) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "O Cãozinho " + Cachorro[cachorro].getNome() + " \n de porte "
                                    + Cachorro[cachorro].getPorte() + " \n da raça " + Cachorro[cachorro].getRaca()
                                    + " \n da (o) propriet\u00E1ria (o) " + Cachorro[cachorro].getProprietario()
                                    + " \n foi cadastrado");
                    ...
                    JOptionPane.showMessageDialog(null,
                            "O peixinho " + Peixe[peixe].getNome() + " \n de porte " + Peixe[peixe].getPorte()
                                    + " \n da espécie " + Peixe[peixe].getEspeciePeixe() + " \n de Àgua "
                                    + Peixe[peixe].getAgua() + " \n da (o) proprietária (o) "
